...
import pe.bsanchez.visora.activity.VisoraGeoPoiClickActivity;
...
public class VisoraGeoPoi extends VisionGeoPoi {
...
//		vista.setMaxLines(2);
		...
		if (categories != null && categories.size() > 0) {
			...
			iv.setImageResource(R.drawable.visora_logo);
			icons.addView(iv);
			iv.layout(0, 0, 30, 30);
			int j = 0;
	...
	public LinearLayout getArrowTextureLayout(Context ctx) {
		...
		iv.setImageDrawable(ctx.getResources().getDrawable(R.drawable.visora_logo));
		top.addView(iv);
	...
	public View drawInfoPanel(Context ctx) {
		...
		LinearLayout.LayoutParams p = new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT,
		...
		miniImage.setImageDrawable(ctx.getResources().getDrawable(R.drawable.visora_logo));
	...
	public View drawMapPopup(Context ctx) {
		LinearLayout pop = (LinearLayout) View.inflate(ctx, R.layout.visora_info_window, null);
	...
	public View drawListItem(Context ctx, View ll) {
		...
		ListView.LayoutParams listparams = new ListView.LayoutParams(LayoutParams.FILL_PARENT,
				LayoutParams.WRAP_CONTENT);
		...
		miniImage.setImageResource(R.drawable.visora_logo);
	...
	public void onClick(Activity activity) {
		...
		final Intent intent = new Intent(activity, VisoraGeoPoiClickActivity.class);
