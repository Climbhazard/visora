...
public class VisoraARManager extends VisionARManager {
	...
	public VisoraARManager(Boolean map, Boolean list, Boolean teleport) {
		super();
		this.map = map;
		this.list = list;
		...
		messageColor = Color.argb(187, 49, 44, 44);
	}
	...
	protected boolean doAction(VisionAction action, int index, LinearLayout dropdown, boolean left,
		...
		default:
			return super
					.doAction(action, index, dropdown, left, top, orientation, camera, activity);
		}
